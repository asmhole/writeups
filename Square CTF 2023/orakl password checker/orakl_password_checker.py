...
# Configuration
SERVER_IP = '184.72.87.9'  # Use the actual IP
SERVER_PORT = 8006         # Use the actual port
CHARSET = string.ascii_letters + string.digits + '_}'
PASSWORD_PREFIX = 'flag{i_wouldve_used_argon2_but_i_didnt_want_to_kill_our_infra}'
THRESHOLD = 30  # Time threshold in seconds
